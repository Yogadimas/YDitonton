...
class _SeasonDetailPageState extends State<SeasonDetailPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context.read<SeasonDetailBloc>().add(
            FetchSeasonDetail(widget.args.tvId, widget.args.seasonNumber),
          );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Season ${widget.args.seasonNumber} Detail')),
  ...
  Widget _buildEpisodesList(List<dynamic> episodes) {
    return Expanded(
    ...
    return Card(
      child: ListTile(
        ...
        leading: episode.stillPath != null
            ...
            : const SizedBox(width: 80, child: Icon(Icons.image)),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Icon(Icons.star, size: 12, color: mikadoYellow),
                const SizedBox(width: 4),
                Text(
